...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "checkcheck — Money, Habit, Tasks, Focus" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "checkcheck — Money, Habit, Tasks, Focus" },
      {
      ...
      { name: "twitter:title", content: "checkcheck — Money, Habit, Tasks, Focus" },
      {
      ...
      { property: "og:image:alt", content: "checkcheck — offline productivity tracker" },
    ],
    links: [
      { rel: "canonical", href: "/" },
      {
